...
public class MovieService extends AsyncTask<Integer, Void, List<MovieSimple>> {

    private static final String TAG = MovieService.class.getCanonicalName();
    private Context context = null;
    private List<MovieSimple> movies;
    private AsyncTaskDelegate asyncTaskDelegate;


    public MovieService(Context context, AsyncTaskDelegate asyncTaskDelegate){
